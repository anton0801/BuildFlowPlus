...
final class DiskPersistence: PersistenceLayer {
    private let store = UserDefaults(suiteName: "group.build.vault")!
    private let cache = UserDefaults.standard
    private var memory: [String: Any] = [:]
    
    private enum Key {
        static let tracking = "bf_tracking_payload"
        static let navigation = "bf_navigation_payload"
        static let endpoint = "bf_endpoint_target"
        static let mode = "bf_mode_active"
        static let firstLaunch = "bf_first_launch_flag"
        static let permApproved = "bf_perm_approved"
        static let permDeclined = "bf_perm_declined"
        static let permDate = "bf_perm_date"
    }
